function [pinhole1Aligned,pinhole2Aligned,keepGoing,shiftHorz,shiftVert]=iterativePinholeAlignment(inputPinhole1,inputPinhole2,whereToLook,averageRange)
...
%both vertically and horizontally
    ...
    [inputPinhole2_h,shiftHorz]=horizontallyAlignPinholes_v2(inputPinhole1,inputPinhole2,whereToLook); %horizontal alignment of pinhole 2
    [inputPinhole2_hv,shiftVert]=verticallyAlignPinholes(inputPinhole1,inputPinhole2_h,averageRange); %vertical alignment of pinhole 2
