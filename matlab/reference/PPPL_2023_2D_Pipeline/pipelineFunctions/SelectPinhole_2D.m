function [Final,new_x_max_location,new_y_max_location]=SelectPinhole_2D(RawData,row,col,max_row,max_col,smooth_type,smooth_pixels,location,smoothing_on_off)
...
Smoothed_array=imgaussfilt(Array_to_smooth,smooth_pixels);
%%
