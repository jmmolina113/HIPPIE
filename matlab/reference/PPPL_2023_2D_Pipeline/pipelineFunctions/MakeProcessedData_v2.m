function [RawData] = MakeProcessedData_v2(shot_location,cal_location,parametersLocation,shot_seq_port)

params=GrabParams_v4(shot_seq_port,parametersLocation); %arg(GrabParams)=(ShotDate_ShotSeq_ShotPort)
cal_params=GrabCalParams_v2(params.cal_shot,parametersLocation); %arg(GrabParams)=(ShotDate_ShotSeq)
