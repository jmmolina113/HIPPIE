...
t1=3.22;
t2=12.55;
[Te_6ns,Final6_1,Final6_2]=EstimateElectronTemperature_Reverse(shot_location,cal_location,shot_seq_port,where_to_look,row,col1,FilterFileName,FilterFileName2,t1,t2);
...
times=[2:8];
Actual2ns=[0 0 0];
T=[Actual2ns; Te_3ns; Te_4ns; Te_5ns; Te_6ns; Te_7ns; Te_8ns];
figure()
plot(times,T)
