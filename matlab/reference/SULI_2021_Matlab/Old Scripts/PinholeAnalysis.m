function [lineout,lineout2,S,Final,Final2,R,G]=PinholeAnalysis(shot_location,cal_location,shot_seq_port,row,col1,col2,smoothing_type,smooth_pixels,where_to_look,Avg_Range,FilterFileName,FilterFileName2,t1,t2,one_or_two)
...
[~,T_Al]=GetFilterTransmission(FilterFileName,t1,0.1);
[E,T_Be]=GetFilterTransmission(FilterFileName2,t2,0.1);
...
T_2=T_Al;
% 
% P=[T_Al(:,1).*T_Be(:,1) T_Al(:,2).*T_Be(:,2) T_Al(:,3).*T_Be(:,3)];
% 
% P-T_2
...
%% Lineout Comparison
S_1=lineout_upper./lineout2_lower;
S_0=lineout./lineout2;
S_2=lineout_lower./lineout2_upper;
